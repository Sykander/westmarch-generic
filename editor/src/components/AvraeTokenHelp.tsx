      ...
      <Tooltip.Root>
        ...
        <Tooltip.Portal>
          <Tooltip.Content className="tooltip" sideOffset={8}>
            Needed only for browser read/publish. It stays in this session and is never added to
            links or exports. Click for setup instructions.
              ...
              >
                <header className="modal-header">
                  <div className="modal-heading">
                    ...
                    <div>
                      ...
                      <p id={descriptionId}>
                        The editor only needs this token when you want to read from or publish to
                        Avrae in this browser.
                      </p>
                    </div>
                  </div>
                  <button
                ...
                <div className="modal-body">
                  <ol className="step-list">
                    ...
                    <li>
                      Go to the storage view: Chrome and Edge call it Application; Firefox calls it
                      Storage.
                    </li>
                    <li>
                    ...
                    <li>
                      Copy the value beside the <code>avrae-token</code> key and paste it into this
                      field.
                    </li>
                  </ol>
                  ...
                  <div className="security-note">
                    ...
                    <div>
                      ...
                      <p>
                        This editor keeps the token in memory only. It is not added to share links,
                        exports, generated gvars, or downloaded files.
                      </p>
                    </div>
                  </div>
