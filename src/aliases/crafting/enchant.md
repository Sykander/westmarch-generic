...
Output handling follows `subsystems.crafting.config.item_handling`: `manual` prints the gained magic item; `bags` adds it to the configured equipment/magic item bag.
