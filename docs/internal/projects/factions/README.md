...
The feature is not part of the first public release. It is tracked on the `2.x.x` roadmap until the final target version is decided.
...
| `2.x.x` | Next-major release candidate for factions unless the final design is strictly additive |
