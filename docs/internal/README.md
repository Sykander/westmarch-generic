...
|--------------|--------|-------------|
| [releases](releases/) | Planned | Release roadmap, including `1.0.0` as the first public release and `1.x.x` additive features |
...
| [factions](projects/factions/) | Planned post-1.0.0 | Config-owned factions that players can join, with membership, rank/renown, requirements, and integrations |
| [forgotten-realms-config](projects/forgotten-realms-config/) | Planned | Richer Forgotten Realms starter config for Sword Coast travel, locations, transport, shops, weather, and services |
